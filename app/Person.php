...
class Person extends Model{
	...
	protected $fillable = array('last_name', 'last_name_born', 'middle_name', 'first_name', 'nick_name', 'birthday', 'deceased_at', 'first_met_at', 'facebook_id', 'blood_type', 'blood_type_rhd', 'default_event_type', 'comment');
